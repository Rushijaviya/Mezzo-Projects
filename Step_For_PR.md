...
For example, Rushijaviya is the owner of this repository, so the GitHub URL for this is: https://github.com/Rushijaviya/Mezzo-Projects

Once you fork this repository, a copy of this repository will be created on your GitHub account. You will be the owner of this newly created repository, so the GitHub URL for this will be: https://github.com/your-username/Mezzo-Projects
...
https://github.com/your-username/Mezzo-Projects.git

You can alternatively copy the URL by using the green “Clone or download” button from your repository page that you just forked from the original repository page. Once you click the button, you’ll be able to copy the URL by clicking the binder button next to the URL.

Once we have the URL, we’re ready to clone the repository. To do this, we’ll combine the git clone command with the repository URL from the command line in a terminal window:

`git clone https://github.com/your-username/Mezzo-Projects.git`
...
Be sure to use the actual name of the repository (i.e. Mezzo-Projects) to switch into that directory.
...
##### `git remote add upstream https://github.com/Rushijaviya/Mezzo-Projects.git`
